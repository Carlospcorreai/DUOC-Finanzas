...
1. **Diferenciar Activos Financieros y Activos Reales**  
   - Comprender cómo los activos financieros representan derechos sobre los ingresos de los activos reales.

2. **Analizar la Relación entre Riesgo y Retorno**  
   - Explorar cómo la diversificación y la teoría de carteras ayudan a gestionar el riesgo en las inversiones.

3. **Introducir la Hipótesis de Mercados Eficientes**  
   - Entender las implicaciones de los mercados eficientes para la toma de decisiones en la inversión.
