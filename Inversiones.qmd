...
- Comprender la diferencia entre activos reales y activos financieros y su papel en la economía.
- Analizar los distintos tipos de activos financieros: renta fija, renta variable y derivados.
- Identificar los actores principales en los mercados financieros y su rol en la inversión y asignación de capital.
- Explorar las estrategias de inversión y su impacto en el riesgo y rendimiento de portafolios.
...
# Actores Principales en los Mercados Financieros

1. **Empresas**  
   - Demandantes netos de capital.
   - Emiten valores para financiar inversiones en activos reales, generando ingresos para los inversores.

2. **Hogares**  
   - Proveedores netos de capital.
   - Compran valores emitidos por empresas, canalizando sus ahorros al mercado.

3. **Gobierno**  
   - Puede ser prestamista o prestatario.
   - Emite T-Bills, bonos y notas para cubrir déficits presupuestarios y financiar gastos.
...
- **Instituciones Financieras**:
  - Bancos, fondos de inversión, compañías de seguros, y uniones de crédito.
  - Facilitan el flujo de capital entre los demandantes (empresas/gobierno) y los proveedores (hogares).

- **Funciones Clave**:
  - Agrupan recursos de pequeños inversores.
  - Ofrecen diversificación para reducir riesgos.
  - Usan economías de escala para evaluar y monitorizar riesgos.
...
1. **Bancos**  
   - Recaudan fondos mediante depósitos y los prestan a otros.
   - Generan ganancias a través de la diferencia de tasas entre depósitos y préstamos.

2. **Fondos de Inversión**  
   - Agrupan dinero de muchos inversores, permitiendo el acceso a carteras diversificadas.

3. **Fondos de Cobertura (Hedge Funds)**  
   - Exclusivos para inversores institucionales y de alto capital, con estrategias más arriesgadas.

---

# Inversión a Escala: Fondos de Inversión

- **Mutual Funds**:  
  - Acceso a carteras diversificadas con baja inversión inicial.
  - Cobran una tarifa de administración.

- **Hedge Funds**:
  - Acceso restringido y estrategias complejas.
  - Tarifa basada en activos gestionados y porcentaje de beneficios generados.

---

# Innovaciones Financieras y Fintech

- **Fintech**: Uso de tecnología para simplificar las finanzas, reduciendo costos y mejorando la accesibilidad.

- **Finanzas Descentralizadas (DeFi)**:
  - Permite interacción directa entre prestamistas y prestatarios.
  - Ejemplo: LendingClub permite préstamos directos entre usuarios sin intermediario bancario.
...
1. **Blockchain**  
   - Libro contable descentralizado para registrar transacciones sin un administrador central.

2. **Criptomonedas**  
   - Ejemplo: Bitcoin y Ethereum, usados como sistemas de pago alternativos.
   - Ofrecen anonimato y mayor seguridad en transacciones.

3. **Stablecoins**  
   - Criptomonedas vinculadas a monedas tradicionales para reducir volatilidad.

---

# Servicios de Asesoría Automática (Robo Advisors)

- Asesores financieros automatizados para inversores.
- Basados en algoritmos que recomiendan carteras de inversión de bajo costo.
- Diseñados para mantener un equilibrio adecuado según la tolerancia al riesgo del cliente.
...
- **Venture Capital (VC)**:
  - Fondos para startups y empresas jóvenes.
  - Inversores como capitalistas de riesgo y "ángeles inversionistas".

- **Private Equity**:
  - Inversiones en empresas que no cotizan en bolsa, con enfoque en reorganización para obtener ganancias.

---

# Actores Principales en los Mercados Financieros

![Actores Mercado Financiero](Actores.png)

---

# Conclusiones de la Clase

- Los activos reales son la base de la riqueza económica de una sociedad, mientras que los activos financieros representan derechos sobre estos activos.
- Existen diferentes tipos de activos financieros, cada uno con características y niveles de riesgo distintos.
- La diversificación es clave en la inversión para gestionar el riesgo y maximizar el retorno.
- La tecnología, incluyendo blockchain y Fintech, está transformando los mercados financieros y facilitando el acceso a inversiones.

---

# Referencias

- Bodie, Z., Kane, A., & Marcus, A. (2021). Investments (13th Edition). McGraw-Hill Education.
- Bolsa de Santiago. Sitio web oficial: www.bolsadesantiago.com
- Comisión para el Mercado Financiero (CMF) de Chile. Sitio web oficial: www.cmfchile.cl
