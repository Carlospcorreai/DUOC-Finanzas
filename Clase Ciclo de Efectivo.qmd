...
### Paso 2: Cálculo del PPC Viña Santa Rita
...
- Reemplazando:
$$
\text{Cuentas por Cobrar Promedio} = \frac{$1.365.558.000 + $1.036.294.000}{2} = $1.200.926.000
$$ 
...
$$
PPC = \frac{1.200.926.000}{455.075.947,22} \approx 2,64  . \text{días}
$$
...
- **Ciclo Operativo**:
$$
\text{Ciclo Operativo} = PPI + PPC = 254,73 + 2,64 = 257,37 \, \text{días}
$$

- **Ciclo de Efectivo**:
$$
\text{Ciclo de Efectivo} = PPI + PPC - PPP = 254,73 + 2,64 - 80,77 = 176,60 \, \text{días}
$$

Estos resultados muestran que Viña Santa Rita necesita **176,60 días** en promedio para convertir sus recursos en efectivo.
