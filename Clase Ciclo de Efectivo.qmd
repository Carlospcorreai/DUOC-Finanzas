...
$$
\text{Inventario Promedio} = \frac{77.701.915.000 + 80.509.166.000}{2} = $79.105.540.500
$$
...
$$
C(o) = \sqrt{\frac{2 \cdot 150 \cdot 13,403,361,833.33}{0.0065}} 
= \sqrt{6,178,674,149,307.69} \approx 2,485,679.38
$$
...
- **Monto mínimo de caja**:  
   $L = 1,500,000$ (definido por la empresa)
...
$$
Z = \sqrt[3]{\frac{3 \cdot b \cdot \sigma^2}{4 \cdot i}} = \sqrt[3]{\frac{3 \cdot 150 \cdot 1,500,000}{4 \cdot 0.00021}} = \sqrt[3]{535,714,285.71} \approx 819.23
$$
