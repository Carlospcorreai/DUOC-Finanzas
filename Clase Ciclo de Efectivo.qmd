...
$$
Ciclo\ Operativo = \text{PPI} (45\ días) + \text{Periodo de Cuentas por Cobrar} (45\ días) 
$$
$$
...
$$
Ciclo\ de\ Efectivo = (\text{Periodo de Inventarios} - \text{PPC}) + \text{PPP}
$$
...
$$
\text{Costo Total} = \text{Costo Comercial} + \text{Costo de Oportunidad} = 282.843 + 282.843 = 565.685
$$
